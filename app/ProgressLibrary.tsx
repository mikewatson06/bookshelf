    ...
    >
      ...
      <header className="site-header">
        ...
        <div className="header-actions">
          ...
          <a
            className="mint-attribution"
            data-testid="mint-attribution"
            href="https://mint.gg"
            target="_blank"
            rel="noreferrer"
            aria-label="Made with Mint. Visit mint.gg"
          >
            <span>Made with</span>
            <MintLogo />
            <span aria-hidden="true" className="mint-attribution__arrow">
              ↗
            </span>
          </a>
        </div>
